...
@HiltViewModel
class HomeViewModel @Inject constructor(val useCase: HomeUseCase, val auth: FirebaseAuth) :
    ViewModel() {

    val profileUrl get() = auth.currentUser?.photoUrl
        ...
        get() {
            ...
            when (currentWeek) {
                ...
                5 -> {
                    ...
                    babySize = BabySize(
                        R.drawable.baby_fruit5,
                        "Your baby is about the size of a sesame seed",
                        0f,
                        0f
                    )
                    babyDesc =
                        "The formation of your baby's neural tube begins, which eventually develops into their brain, spinal cord, and backbone. Small buds emerge, which will later develop into your baby's arms and legs. The development of your baby's heart and lungs is underway, and their heart begins to beat."
                }
                6 -> {
                    babyImage = R.drawable.baby_month1
                    babySize = BabySize(
                        R.drawable.baby_fruit6_lentil,
                        "Your baby is about the size of a lentil",
                        0f,
                        0f
                    )
                    babyDesc =
                        "Your baby's heart is beating at approximately 105 times per minute. The formation of her nose, mouth, fingers, toes, and ears is occurring, and they are starting to take shape."
                }
                7 -> {
                    babyImage = R.drawable.baby_month1
                    babySize = BabySize(
                        R.drawable.baby_fruit7_blueberry,
                ...
                8 -> {
                    babyImage = R.drawable.baby_month1
                    babySize = BabySize(
                        R.drawable.baby_fruit8_kidneybean,
                ...
                10 -> {
                    babyImage = R.drawable.baby_month2
                    babySize = BabySize(
                        R.drawable.baby_fruit10_kumquat,
                        "Your baby is about the size of a kumquat",
                        3.1f,
                        35f
                    )
                    babyDesc =
                        "Continued development of fingers and toes is taking place, along with the growth of your baby's nails. During your prenatal care checkup, you may have the opportunity to hear your baby's heartbeat."
                }
                11 -> {
                    babyImage = R.drawable.baby_month2
                    babySize = BabySize(
                        R.drawable.baby_fruit11_fig,
                ...
                12 -> {
                    babyImage = R.drawable.baby_month2
                    babySize = BabySize(
                        R.drawable.baby_fruit12_lime,
                        "Your baby is about the size of a lime",
                        5.4f,
                        58f
                    )
                    babyDesc =
                        "Your baby's hands exhibit more rapid development compared to her feet. Although she is active and moving, you may not yet perceive her movements. At this stage, she measures approximately 2 inches in length and weighs around ½ an ounce."
                }
                13 -> {
                    babyImage = R.drawable.baby_month3
                    babySize = BabySize(
                        R.drawable.baby_fruit13_peapod,
                        "Your baby is about the size of a peapod",
                        6.7f,
                        73f
                    )
                    babyDesc =
                        "You have entered the second trimester of your pregnancy! Your baby is undergoing rapid growth. Her organs have already formed and are continuing to develop. During an ultrasound, you may observe movements that resemble breathing and swallowing in your baby."
                }
                14 -> {
                    babyImage = R.drawable.baby_month3
                    babySize = BabySize(
                        R.drawable.baby_fruit14_lemon,
                ...
                16 -> {
                    babyImage = R.drawable.baby_month3
                    babySize = BabySize(
                        R.drawable.baby_fruit16_avocado,
                        "Your baby is about the size of an avocado",
                        18.6f,
                        146f
                    )
                    babyDesc =
                        "Your baby's eyelids, upper lip, and ears have reached a significant stage of development. She has also developed the ability to hear, so feel free to engage in conversations or sing to her as often as you wish. At this point, your baby measures approximately 5 inches in length and weighs around 5 ounces."
                }
                17 -> {
                    babyImage = R.drawable.baby_month4
                    babySize = BabySize(
                        R.drawable.baby_fruit17_turnip,
                ...
                18 -> {
                    babyImage = R.drawable.baby_month4
                    babySize = BabySize(
                        R.drawable.baby_fruit18_bellpepper,
                        "Your baby is about the size of a bell pepper",
                        22.2f,
                        223f
                    )
                    babyDesc =
                        "You may have your first ultrasound this week—it's the first time you get to \"see\" your baby! You may be able to tell if your baby's a boy or girl, so be sure to tell your provider if you don’t want to know. Your baby goes to sleep and wakes up throughout the day. Loud noises and your movements can wake her. Her skin has lanugo. This is soft, fine hair that helps keep her warm in the womb. rephrase these words"
                }
                19 -> {
                    babyImage = R.drawable.baby_month4
                    babySize = BabySize(
                        R.drawable.baby_fruit19_heirloomtomato,
                ...
                20 -> {
                    babyImage = R.drawable.baby_month4
                    babySize = BabySize(
                        R.drawable.baby_fruit20_banana,
                ...
                21 -> {
                    ...
                    babySize = BabySize(
                        R.drawable.baby_fruit21_carrot,
                        "Your baby is about as long as a carrot",
                        27.4f,
                        399f
                    )
                    babyDesc =
                ...
                22 -> {
                    babyImage = R.drawable.baby_month5
                    babySize = BabySize(
                        R.drawable.baby_fruit22_spaghettisquash,
                ...
                23 -> {
                    babyImage = R.drawable.baby_month5
                    babySize = BabySize(
                        R.drawable.baby_fruit23_largemango,
                ...
                24 -> {
                    babyImage = R.drawable.baby_month5
                    babySize = BabySize(
                        R.drawable.baby_fruit24_corn,
                        "Your baby is about as long as an ear of corn",
                        32.2f,
                        670f
                    )
                    babyDesc =
                ...
                25 -> {
                    ...
                    babySize = BabySize(
                        R.drawable.baby_fruit25_rutabaga,
                        "Your baby is about the size of a rutabaga",
                        33.7f,
                        785f
                    )
                    babyDesc =
                        "Her nervous system is developing quickly. The nervous system is the brain, spinal cord and nerves. It helps your baby move, think and feel. Your baby adds more fat to her body, which makes her skin look smooth and less wrinkly."
                }
                26 -> {
                    babyImage = R.drawable.baby_month6
                    babySize = BabySize(
                        R.drawable.baby_fruit26_scallion,
                        "Your baby is about the length of a scallion",
                        35.1f,
                        913f
                    )
                    babyDesc =
                ...
                27 -> {
                    babyImage = R.drawable.baby_month6
                    babySize = BabySize(
                        R.drawable.baby_fruit27_cauliflower,
                ...
                28 -> {
                    babyImage = R.drawable.baby_month6
                    babySize = BabySize(
                        R.drawable.baby_fruit28_eggplant,
                        "Your baby is about the size of a large eggplant",
                        37.6f,
                        1210f
                    )
                    babyDesc =
                        "You have entered the third trimester of pregnancy! Your baby has eyelashes and she can open and close her eyes. Your baby is about 14 inches long and weighs about 2½ pounds."
                }
                29 -> {
                    babyImage = R.drawable.baby_month7
                    babySize = BabySize(
                        R.drawable.baby_fruit29_butternutsquash,
                ...
                30 -> {
                    babyImage = R.drawable.baby_month7
                    babySize = BabySize(
                        R.drawable.baby_fruit30_cabbage,
                ...
                31 -> {
                    babyImage = R.drawable.baby_month7
                    babySize = BabySize(
                        R.drawable.baby_fruit31_coconut,
                ...
                32 -> {
                    babyImage = R.drawable.baby_month7
                    babySize = BabySize(
                        R.drawable.baby_fruit32_jicama,
                ...
                33 -> {
                    ...
                    babySize = BabySize(
                        R.drawable.baby_fruit33_pineapple,
                ...
                34 -> {
                    babyImage = R.drawable.baby_month8
                    babySize = BabySize(
                        R.drawable.baby_fruit34_cantaloupe,
                        "Your baby is about the size of cantaloupe",
                        45.3f,
                        2377f
                    )
                    babyDesc =
                ...
                35 -> {
                    babyImage = R.drawable.baby_month8
                    babySize = BabySize(
                        R.drawable.baby_fruit35_honeydewlemon,
                ...
                36 -> {
                    babyImage = R.drawable.baby_month8
                    babySize = BabySize(
                        R.drawable.baby_fruit36_lettuce,
                        "Your baby is about as long as a head of romaine lettuce",
                        47.3f,
                        2813f
                    )
                    babyDesc =
                ...
                37 -> {
                    ...
                    babySize = BabySize(
                        R.drawable.baby_fruit37_swisschard,
                        "Your baby is about the length of a bunch of Swiss chard",
                        48.3f,
                        3028f
                    )
                    babyDesc =
                ...
                39 -> {
                    babyImage = R.drawable.baby_month9
                    babySize = BabySize(
                        R.drawable.baby_fruit39_miniwatermelon,
                ...
                40 -> {
                    babyImage = R.drawable.baby_month9
                    babySize = BabySize(
                        R.drawable.baby_fruit40_smallpumpkin,
    ...
    val exercise: String
        get() {
            return when (currentWeek) {
                in Constants.FIRST_TRIMESTER -> {
                    "- Gentle prenatal yoga or stretching exercises for relaxation and flexibility. Aim for 2-3 sessions per week.\n" +
                            "- Daily walks for 20-30 minutes to maintain overall fitness and boost circulation."
                }
                in Constants.SECOND_TRIMESTER -> {
                    "- Prenatal swimming or water aerobics for cardiovascular conditioning and muscle toning. Aim for 2-3 sessions per week.\n" +
                            "- Prenatal strength training with light weights or resistance bands to maintain muscle strength and support proper posture. Include exercises for both upper and lower body. Aim for 2 sessions per week.\n" +
                            "- Pelvic floor exercises (Kegels) to strengthen the pelvic muscles. Perform daily."
                }
                in Constants.THIRD_TRIMESTER -> {
                    "- Brisk walking for 30-45 minutes daily to maintain cardiovascular health and prepare for labor.\n" +
                            "- Prenatal yoga or gentle stretching exercises for relaxation and flexibility. Aim for 2-3 sessions per week.\n" +
                            "- Breathing exercises and relaxation techniques to prepare for labor and reduce stress.\n"
                }
