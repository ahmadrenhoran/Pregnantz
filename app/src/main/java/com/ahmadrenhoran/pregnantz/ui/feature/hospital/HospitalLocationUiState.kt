...
import com.ahmadrenhoran.pregnantz.ui.feature.hospital.component.MapStyle
...
data class HospitalLocationUiState(
    ...
    val mapProperties: MapProperties = MapProperties(isTrafficEnabled = true, isBuildingEnabled = true, mapStyleOptions = MapStyleOptions(
        MapStyle.json)),
